...
`;
export function DiscordHighlightedCode(props) {
    const highlighted = props.language
        ? hljs.highlight(props.content, { language: props.language })
        : hljs.highlightAuto(props.content);
    return _jsx("discord-code", { multiline: true, className: "theme-dark hljs", dangerouslySetInnerHTML: { __html: highlighted.value } });
}
