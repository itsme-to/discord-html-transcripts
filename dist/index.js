...
import { ExportReturnType, } from './types.js';
import { TranscriptImageDownloader } from './downloader/images.js';
// re-exports
...
if (versionPrefix !== '14' && versionPrefix !== '15') {
    console.error(`[discord-html-transcripts] Versions v3.x.x of discord-html-transcripts are only compatible with discord.js v14.x.x and v15.x.x, and you are using v${version}.` +
 ...
 */
export async function generateFromMessages(messages, channel, options = {}) {
